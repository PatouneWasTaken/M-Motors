...
<?php foreach ($vehicles as $v):
	...
	if (
		!empty($v['photo']) &&
		file_exists(__DIR__ . '/../../public/uploads/' . $v['photo'])
	) {
		$image = "/uploads/" . e($v['photo']);
	}
?>
	...
	<article class="admin-vehicle-row">
    	...
    	<p class="actions">
        	<a class="edit-btn" href="/index.php?page=admin_edit_vehicle&id=<?= (int)$v['id'] ?>">Modifier</a>

        	<form action="/index.php?page=admin_delete_vehicle" method="POST" onsubmit="return confirm('Supprimer ce véhicule ? Les dossiers liés seront aussi supprimés.');">
